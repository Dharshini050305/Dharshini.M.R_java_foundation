...
public class BankRepositoryImpl implements IBankRepository {
    ...
    public void createAccount(long accountNumber, String accountType, double balance, double additionalInfo) {
        ...
        case "savings":
            newAccount = new entity.SavingsAccount(accountNumber, balance, null, additionalInfo);
            break;
        case "current":
            newAccount = new entity.CurrentAccount(accountNumber, balance, null, additionalInfo);
            break;
        case "zero-balance":
            newAccount = new entity.ZeroBalanceAccount(accountNumber, balance, null);
            break;
        default:
